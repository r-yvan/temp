    ...
    <div className="w-full h-full overflow-y-auto overflow-x-hidden p-2 text-sm">
      <div className="my-5 grid grid-cols-2 gap-5">
        ...
        <div className="w-[50%] md:w-full">
          <p className=" w-full  my-2 px-3 py-2 text-black  bg-[rgba(67,67,67,0.03)]  rounded-md border-[2px] border-[rgba(67,67,67,0.09)]">
            {student.name}
          </p>
          <p className=" w-full  my-2 px-3 py-2 text-black  bg-[rgba(67,67,67,0.03)]  rounded-md border-[2px] border-[rgba(67,67,67,0.09)]">
            {student.email}
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="my-10 flex flex-row gap-2">
          <button className="bg-primary rounded-md text-white px-5 py-2 cursor-pointer">
            Edit
          </button>
          <button className="bg-[#DD1A49] rounded-md text-white px-5 py-2 cursor-pointer">
            Delete
          </button>
        </div>
      </div>
