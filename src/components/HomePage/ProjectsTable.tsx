  ...
  return (
    <div>
      {loading ? (
        ...
        <div>
          {projects?.length === 0 ? (
            <div>No Projects So Far</div>
          ) : (
            <div>
              <div className="flex flex-row justify-between my-2 items-center">
                <p className="text-[rgba(67,67,67,0.43)]">
                  Information about Projects & Innovations
                </p>
                <Link href={'/projects'} className="text-[#3C64CA] font-semibold text-[14px]">
                  View more
                </Link>
              </div>
              <table className="w-full rounded-lg text-[rgba(67,67,67,0.71)]">
                <tr className="bg-[rgba(237,238,243)] text-[rgba(48,7,98,0.8)] py-10 rounded-md ">
                  <th className="p-2 rounded-l-xl  border-[#F7F8FD] border-y-[5px]">#</th>
                  <th className="p-2 border-[#F7F8FD] border-y-[5px]">Project Name</th>
                  <th className="p-2 border-[#F7F8FD] border-y-[5px]">Number of Comments</th>
                  <th className="p-2 border-[#F7F8FD] border-y-[5px]">View</th>
                  <th className="p-2 rounded-r-xl border-[#F7F8FD] border-y-[5px]">Remove</th>
                </tr>
                {projects?.map((project: any, index: any) => (
                  ...
                  >
                    ...
                    <td className="p-2 border-[#F7F8FD] border-y-[5px]">{project.name}</td>
                    <td className="p-2 border-[#F7F8FD] border-y-[5px]">
                    ...
                    <td className="p-2 border-[#F7F8FD] border-y-[5px]">
                      <svg
                        ...
                        height="18"
                        viewBox="0 0 21 18"
                        className="cursor-pointer w-3 h-3 mx-auto fill-blue-500"
                      >
                        <path
                    ...
                    <td className="p-2 border-[#F7F8FD] border-y-[5px] rounded-r-xl">
                      ...
                      >
                        <path
                          d="M10 20C4.477 20 0 15.523 0 10C0 4.477 4.477 0 10 0C15.523 0 20 4.477 20 10C20 15.523 15.523 20 10 20ZM10 18C12.1217 18 14.1566 17.1571 15.6569 15.6569C17.1571 14.1566 18 12.1217 18 10C18 7.87827 17.1571 5.84344 15.6569 4.34315C14.1566 2.84285 12.1217 2 10 2C7.87827 2 5.84344 2.84285 4.34315 4.34315C2.84285 5.84344 2 7.87827 2 10C2 12.1217 2.84285 14.1566 4.34315 15.6569C5.84344 17.1571 7.87827 18 10 18ZM14.891 6.523L6.523 14.891C5.97638 14.5015 5.49849 14.0236 5.109 13.477L13.477 5.109C14.0236 5.49849 14.5015 5.97638 14.891 6.523Z"
                          fill="#C80048"
                        />
                      </svg>
                    </td>
