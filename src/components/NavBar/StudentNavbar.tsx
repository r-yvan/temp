...
const StudentNavbar: React.FC<Props> = ({ logginPage, showSearch }) => {
  ...
  return (
    <div className="flex flex-row justify-between items-center mx-3 bg-[#D9D9D975] border-2 border-[#43434305] p-1 rounded-md  ">
      {!logginPage && (
        <button
          onClick={() => {
            setMobileNav(true);
          }}
          className="block md:hidden transition-all duration-200 text-black"
        >
          <svg
            viewBox="0 0 24 24"
            fill="none"
      ...
      <div
        ...
        } transition-all duration-300  md:hidden pl-3 py-2 h-screen bg-white z-50 `}
      >
        <div className="bg-[#D9D9D975] border-2 border-[#43434305] p-1 rounded-md h-full  w-[70vw] sm:w-[50vw]  text-[#00000075] text-sm">
          ...
          <div className="font-medium" onClick={() => setMobileNav(false)}>
            <Link
              href={'/student'}
              className={
                isActiveLink('/student')
                  ? 'flex flex-row gap-5 items-center p-3 rounded-lg bg-primary/20 text-primary my-2'
                  : 'flex flex-row gap-5 items-center p-3 rounded-lg hover:bg-primary/20 hover:text-primary my-2'
              }
            >
              <svg
                width="22"
            ...
            <Link
              ...
              className={
                isActiveLink('/student/profile')
                  ? 'flex flex-row gap-5 items-center p-3 rounded-lg bg-primary/20 text-primary my-2'
                  : 'flex flex-row gap-5 items-center p-3 rounded-lg hover:bg-primary/20 hover:text-primary my-2 hover:fill-[]'
              }
            >
              <svg
                width="20"
      ...
      {!logginPage && showSearch && (
        <div className="hidden md:block bg-[white]   relative w-[45%]  rounded-md">
          <input
            type="text"
            placeholder="Search of pages here  .  .  ."
            className="h-full w-full px-7 pr-10 py-2  border-[1px]   border-[#2a0a5236] rounded-md outline-none text-[12px] font-semibold"
          />
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="19"
            ...
            viewBox="0 0 21 21"
            fill="none"
            className="absolute right-2 cursor-pointer top-[30%]"
          >
            <path
      ...
      <div className="h-10 w-10 bg-[#0828D230] p-[0.3rem] rounded-full flex items-center justify-center">
        <div className="h-full w-full rounded-full bg-[#0828D296]"></div>
      </div>
    </div>
  );
};
